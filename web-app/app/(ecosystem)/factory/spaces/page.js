...
const page = () => {
  return (
    <section className='grid items-start justify-start min-h-[90vh] grid-cols-1 lg:grid-cols-2 gap-8 p-4 lg:p-8'>
      <div className='grid col-span-1 gap-8 py-8'>
        <a
      ...
      <div className="grid content-end w-full h-full grid-cols-2 col-span-1 py-8 gap-4 lg:grid-cols-3 lg:pt-[40vh]">
      ...
      <div className="grid content-end w-full h-full grid-cols-2 col-span-2 gap-4 py-8 border-t-2 border-black lg:grid-cols-6">
        ...
        <NsCard chain="DREAM" tokenId="777" spaceTld=".fantasy" spaceName="Fantasy Realm Explorers" spaceDesc="Unveiling the magical mysteries of enchanting worlds." />      </div>
    </section>
  )
}
