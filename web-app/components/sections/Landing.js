        ...
        <div className="grid min-h-[110vh] grid-cols-2 gap-8 py-8 lg:grid-cols-4">
          <div className="flex flex-col col-span-2 space-y-5">
            ...
            <h1 className="max-w-2xl">
              Unlock boundless possibilities of <br /><Typing toRotate={["blockchain names", "blockchain spaces", "storage networks", "unified identity", "holistic profile", "names services"]} />
            </h1>
            <p className="text-lg">
          ...
          <div className="grid content-end w-full h-full grid-cols-1 col-span-2 gap-4 lg:grid-cols-2">
            ...
            >
              ...
              <span className="pt-2 uppercase accent space group-hover:text-white">
                Claim unique names
                <span className="inline-block pl-2 transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
                  &gt;
                </span>
